...
public class OccupancyCSVReader {
        ...
        public static ArrayList<OccupancyReading> loadOccupancyData() {
            ...
            try (InputStream inputStream = com.dataReader.OccupancyCSVReader.class.getClassLoader().getResourceAsStream("OccupancyData.csv");
        ...
        private static void scheduleTimer() {
            timer = new Timer();
            timer.scheduleAtFixedRate(new com.dataReader.OccupancyCSVReader.Task(), 0, 15000); // Schedule the task to run every 15 seconds
        }
