...
public class EnvironmentCSVReader {
        ...
        public static ArrayList<EnvironmentReading> loadEnvironmentData() {
            ...
            try (InputStream inputStream = com.dataReader.EnvironmentCSVReader.class.getClassLoader().getResourceAsStream("EnvironmentData.csv");
        ...
        private static void scheduleTimer() {
            timer = new Timer();
            timer.scheduleAtFixedRate(new com.dataReader.EnvironmentCSVReader.Task(), 0, 15000); // Schedule the task to run every 15 seconds
        }
